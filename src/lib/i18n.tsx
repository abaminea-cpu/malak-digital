...
const DICT = {
  fr: {
    ...
    "hero.subtitle": "Une expérience d'achat haut de gamme, pensée pour l'Algérie. Paiement à la livraison dans les 58 wilayas.",
    ...
    "why.shipping.title": "Livraison 58 wilayas",
  ...
  en: {
    ...
    "hero.subtitle": "A premium shopping experience for Algeria. Cash on delivery across all 58 wilayas.",
    ...
    "why.shipping.title": "58 wilayas covered",
