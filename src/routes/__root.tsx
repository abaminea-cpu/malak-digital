...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Malak Digital, la boutique en ligne premium d'Algérie. Paiement à la livraison dans les 58 wilayas." },
      { name: "author", content: "Malak Digital" },
      { property: "og:title", content: "Malak Digital — Boutique en ligne premium en Algérie" },
      { property: "og:description", content: "Boutique premium algérienne. Paiement à la livraison dans les 58 wilayas." },
